...
# 	slides = sorted(os.listdir(source))
    ...
    for i in range(len(file_list)):
        wsi_path =source + '%s/%s' % (file_list.iloc[i]['folder'], file_list.iloc[i]['filename'])
...
parser.add_argument('--source', type = str,default='/home6/svs_files/',
...
parser.add_argument('--save_dir', type = str,default='/home1/gzy/Nature/CLAM/test/',
